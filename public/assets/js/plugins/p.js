...
var customvar = {
    ...
    productTermList: {
        ...
        marketingautomation: "https://www.zoho." + domainOne + "/marketingautomation/terms-of-/service",
        ...
        for (var t = 0; t < e.length; t++) {
            if (
                ...
                var a = e.eq(t).attr("href").split("/").indexOf("help") < 0,
                    ...
                    D = e.eq(t).attr("href").indexOf("/sprints//contact") < 0,
                    P = e.eq(t).attr("href").indexOf("/backstage//contact") < 0,
                    q =
                        e
                            .eq(t)
                            .attr("href")
                            .indexOf("https://www.zoho." + domainOne + "/teamdrive//contact") < 0,
                    M =
                        e
                            .eq(t)
                            .attr("href")
                            .indexOf("https://www.zoho." + domainOne + "/workdrive//contact") < 0,
                    I = e.eq(t).attr("href").indexOf("webinars.html") < 0,
                    R = e.eq(t).attr("href").indexOf("analytics/onpremise/get-quote.html") < 0,
                    B = e.eq(t).attr("href").indexOf("/workdrive//contact") < 0,
                    A = !0;
