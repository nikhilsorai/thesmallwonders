...
export default function WhyRitualsPage() {
  return (
    <>
      {/* Page header */}
      <section className="section-pad-sm bg-white border-b border-[rgba(34,34,34,0.06)]">
            ...
            {tracks.map((track) => (
              ...
              >
                <div>
                  ...
                  <div className="mb-8">
                    <p className="text-[0.6875rem] font-semibold tracking-[0.14em] uppercase text-[#242320]/45 mb-4 font-sans">
